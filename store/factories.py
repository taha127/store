...
class ProductFactory(DjangoModelFactory):
    ...
    name = factory.LazyAttribute(lambda x: ' '.join(
...
class OrderFactory(DjangoModelFactory):
    ...
    status = factory.LazyFunction(lambda: random.choice(
        [models.Order.ORDER_STATUS_UNPAID, models.Order.ORDER_STATUS_CANCELLED]))
...
class CommentFactory(DjangoModelFactory):
    ...
    status = factory.LazyFunction(lambda: random.choice(
        [models.Comment.COMMENT_STATUS_PENDING, models.Comment.COMMENT_STATUS_APPROVED, models.Comment.COMMENT_STATUS_REJECTED]))
